...
Privacy protection is the most important problem in data sharing, especially for those containing face images. 
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{figure/sisFri} 
...
Build a tensor-based model

focus on some specific dimension
